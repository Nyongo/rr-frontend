...
export const UserActivationDialog = ({
  ...
  const [activationItems, setActivationItems] = useState<ActivationItem[]>([
    {
      id: 'user',
      label: 'User',
      description: 'This will allow the user to log back into their account.',
      status: 'pending'
    }
  ]);
  ...
  const handleActivate = async () => {
    ...
    toast({
      ...
      description: `User ${userName} has been successfully activated and can now log into their account.`,
    });
    onClose();
    resetDialog();
  };
    ...
    return (
      <Dialog open={isOpen} onOpenChange={() => {}}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Activating User {userName}</DialogTitle>
            <DialogDescription>
              Please wait while we activate the user and update all related systems...
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            This action will activate the user and allow them to access their account. Please review the changes below.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert className="border-green-200 bg-green-50">
          ...
          <AlertDescription className="text-green-800">
            <strong>Notice:</strong> Activating this user will allow them to log back into their account.
          </AlertDescription>
        </Alert>
