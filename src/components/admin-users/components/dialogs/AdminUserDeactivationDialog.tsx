...
interface AdminUserDeactivationDialogProps {
  isOpen: boolean;
  onClose: () => void;
  userName: string;
  onConfirm: () => void;
...
export const AdminUserDeactivationDialog = ({
  isOpen,
  onClose,
  userName,
  onConfirm,
}: AdminUserDeactivationDialogProps) => {
  ...
  >([
    {
      id: "access",
      label: "System Access",
      description: "User access to the system will be revoked immediately.",
      status: "pending",
    },
    {
      id: "sessions",
      ...
      description:
        "All active sessions will be terminated and the user will be logged out.",
      status: "pending",
    },
  ]);
    ...
    return (
      <Dialog open={isOpen} onOpenChange={() => {}}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Deactivating {userName}</DialogTitle>
            <DialogDescription>
              Please wait while we deactivate the user account...
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            This action will deactivate the user account. Please review the
            impact below.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            <strong>Warning:</strong> Deactivating this user will revoke their
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <Label htmlFor="confirmation" className="text-sm font-medium">
              Type{" "}
              <span className="font-bold bg-red-100 px-1 rounded">
                DEACTIVATE
              </span>{" "}
              to confirm:
            </Label>
