...
interface AdminUserActivationDialogProps {
  isOpen: boolean;
  onClose: () => void;
  userName: string;
  onConfirm: () => void;
...
export const AdminUserActivationDialog = ({
  isOpen,
  onClose,
  userName,
  onConfirm,
}: AdminUserActivationDialogProps) => {
  ...
  const [activationItems, setActivationItems] = useState<ActivationItem[]>([
    {
      id: "access",
      label: "System Access",
      description: "User access to the system will be restored immediately.",
      status: "pending",
    },
    {
      id: "sessions",
      label: "Login Sessions",
      description: "User will be able to create new login sessions.",
      status: "pending",
    },
  ]);
  ...
  const handleActivate = async () => {
    ...
    toast({
      ...
      description: `${userName} has been successfully activated.`,
    });
    onClose();
    resetDialog();
  };
    ...
    return (
      <Dialog open={isOpen} onOpenChange={() => {}}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Activating {userName}</DialogTitle>
            <DialogDescription>
              Please wait while we activate the user account...
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            This action will activate the user account. Please review the impact
            below.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert className="border-green-200 bg-green-50">
          ...
          <AlertDescription className="text-green-800">
            <strong>Notice:</strong> Activating this user will restore their
