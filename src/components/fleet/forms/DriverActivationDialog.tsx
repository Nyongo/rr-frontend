...
export const DriverActivationDialog = ({ 
  isOpen, 
  onClose, 
  driverName, 
  onConfirm 
  ...
  const [activationItems, setActivationItems] = useState<ActivationItem[]>([
    {
      id: 'driver',
      label: 'Driver',
      description: 'Drivers will be able to login to their account and be able to be assigned to the next trips only.',
      status: 'pending'
    }
  ]);
  ...
  const handleActivate = async () => {
    ...
    toast({
      ...
      description: `Driver ${driverName} has been successfully activated and is now available for service.`,
    });
    onClose();
    resetDialog();
  };
    ...
    return (
      <Dialog open={isOpen} onOpenChange={() => {}}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Activating Driver {driverName}</DialogTitle>
            <DialogDescription>
              Please wait while we activate the driver and update all related systems...
            </DialogDescription>
          </DialogHeader>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-green-600">
            ...
            Activate Driver {driverName}
          </DialogTitle>
          <DialogDescription>
            This action will activate the driver and make them available for service. Please review the changes below.
          </DialogDescription>
        </DialogHeader>
        ...
        <Alert className="border-green-200 bg-green-50">
          ...
          <AlertDescription className="text-green-800">
            <strong>Notice:</strong> Activating this driver will make them available for upcoming trips and operations.
          </AlertDescription>
        </Alert>
